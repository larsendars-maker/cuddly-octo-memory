...
Базовый администратор задаётся через `ADMIN_USERNAME` (по умолчанию `Larsenda`). Дополнительных администраторов можно назначать прямо из вкладки «Администраторы» в админ-панели — без правки файлов и нового deploy.
